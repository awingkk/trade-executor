...
from tradeexecutor.solana.raydium.raydium_routing_state import (
    RaydiumRoutingState,
)
from tradeexecutor.solana.raydium.raydium_routing_model import (
    RaydiumRoutingModel,
)
...
def ray_asset() -> AssetIdentifier:
    ...
    a = AssetIdentifier(102, key_hex, "RAY", 18)
